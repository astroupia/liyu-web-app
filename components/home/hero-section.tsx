  ...
  return (
    <div className="relative min-h-screen flex items-center">
      <div
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1555244162-803834f70033?ixlib=rb-4.0.3")',
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              asChild
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-[#532516] px-8 py-6 text-lg"
            >
